...
<body>
                ...
                <div class="coverflow" id="coverflow">
                    <div class="coverflow-item" data-index="0">
                        <div class="cover image-loading">
                            <img src="images/coverflow-images/DiningHallImage.png" alt="The Underground in Grier Center"
                                loading="lazy">
                        </div>
                    ...
                    <div class="coverflow-item" data-index="5">
                        <div class="cover image-loading">
                            <img src="images/coverflow-images/GreenwoodMarketplaceImage.png" alt="Greenwood Marketplace"
                                loading="lazy">
                        </div>
                        <div class="reflection"></div>
                    </div>
                    <div class="coverflow-item" data-index="6">
                        <div class="cover image-loading">
                            <img src="images/coverflow-images/FoodPantryImage.jpg" alt="Bear Necessities Food Pantry"
                                loading="lazy">
                        </div>
                        <div class="reflection"></div>
                    </div>
                    ...
                    <div class="showcase-display">
                        <div class="showcase-main">
                            ...
                            <div class="showcase-badges">
                                <a href="" target="_blank" rel="noopener noreferrer" class="badge">Unlimited Access</a>
                                <a href="" target="_blank" rel="noopener noreferrer" class="badge">20 Meal Exchanges</a>
                                <a href="" target="_blank" rel="noopener noreferrer" class="badge">10 Visitor Meals</a>
                                <a href="" target="_blank" rel="noopener noreferrer" class="badge">$100 Bearcat
                                    Bucks</a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="about-visual">
                    <div class="showcase-display">
                        <div class="showcase-main">
                            ...
                            <div class="showcase-badges">
                                <a href="" target="_blank" rel="noopener noreferrer" class="badge">145 Swipes</a>
                                <a href="" target="_blank" rel="noopener noreferrer" class="badge">20 Meal Exchange</a>
                                <a href="" target="_blank" rel="noopener noreferrer" class="badge">10 Visitor Meals</a>
                                <a href="" target="_blank" rel="noopener noreferrer" class="badge">$450 Bearcat
                                    Bucks</a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="about-visual">
                    <div class="showcase-display">
                        <div class="showcase-main">
                            ...
                            <p class="showcase-subtitle">No more than 5 times in one day in the Dining Hall</p>
                            <div class="showcase-badges">
                                <a href="" target="_blank" rel="noopener noreferrer" class="badge">90 Swipes</a>
                                <a href="" target="_blank" rel="noopener noreferrer" class="badge">10 Meal Exchange</a>
                                <a href="" target="_blank" rel="noopener noreferrer" class="badge">5 Visitor Meals</a>
                                <a href="" target="_blank" rel="noopener noreferrer" class="badge">$350 Bearcat
                                    Bucks</a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="about-visual">
                    <div class="showcase-display">
                        <div class="showcase-main">
                            ...
                            <p class="showcase-subtitle">No more than 5 times in one day in the Dining Hall</p>
                            <div class="showcase-badges">
                                <a href="" target="_blank" rel="noopener noreferrer" class="badge">50 Swipes</a>
                                <a href="" target="_blank" rel="noopener noreferrer" class="badge">10 Meal Exchange</a>
                                <a href="" target="_blank" rel="noopener noreferrer" class="badge">$275 Bearcat
                                    Bucks</a>
                            </div>
                        </div>
                    </div>
    ...
    <section id="events" class="section">
        <div class="events-content">
            <div class="section-header">
                <h2>Calendar</h2>
                <div class="events-item" onclick="window.location.href='calendar.html'">
            ...
            <div class="events-main">
                <div class="events-visual">
                    <div class="events-showcase-display">
                        <div class="events-showcase-main">
                            <div class="corner-decoration top-left"></div>
                            <div class="corner-decoration bottom-right"></div>
                            <div class="event-tag"><i class="fa-solid fa-gift"></i> Festival</div>
                            <h3 class="event-title">Food & Ideas Festival</h3>
                            <p class="event-desc">The second annual festival expanded to include a student start-up food
                                market,
                                a school outreach programme, and a live cook-off between faculty heads. Ticket pre-sales
                                exceeded last year's total attendance within 48 hours of opening.</p>
                            <div class="event-badges">
                                <a href="#" class="badge">Live cook-off</a>
                                <a href="#" class="badge">Faculty heads</a>
                                <a href="#" class="badge">Total</a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="about-bottom-row">
                ...
                <div class="about-info">
                    <div class="section-header">
                        ...
                        <p>Mobile Ordering offers a convenient method to order, pay, and pick up food directly from a
                            mobile
            ...
            <div class="contact-container">
                <div class="contact-info-section">
                    ...
                    <div class="contact-details">
                        ...
                        <div class="contact-item"
                            onclick="window.location.href='https://www.google.com/maps/place/Lander+University+-+Greenwood,+SC/@34.1994893,-82.1693028,17z/data=!3m1!4b1!4m6!3m5!1s0x88f8010ea801bc91:0x3f045de1f19854a8!8m2!3d34.1994849!4d-82.1667332!16zL20vMDM1OThs?entry=ttu&g_ep=EgoyMDI2MDMwMi4wIKXMDSoASAFQAw%3D%3D'">
                            <div class="contact-icon">
                                <svg viewBox="0 0 24 24">
                                    <path
